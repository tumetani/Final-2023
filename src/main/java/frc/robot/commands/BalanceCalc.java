...
public class BalanceCalc {
    ...
    private double permissibleDegreeRange;
    ...
    public BalanceCalc() {
        ...
        // [ADD] TODO: make same description
        permissibleDegreeRange = 1.5;
    ...
    public double getTilt() {
        /* 
         * NOTE: Expectable return values from robots in various conditions
         * horizontal -> around -1.5
         * climbing (UP) -> -1.5 to 8
         * climbing (DOWN) -> -1.5 to -4
         */ 
    ...
    public double autoBalanceRoutine() {
        switch (state) {
            ...
            case 2:
                if (Math.abs(getTilt() - levelDegree) <= permissibleDegreeRange) { // TODO: change it
                    debounceCount++;
                }
                if (debounceCount > secondsToTicks(debounceTime)) { // stable for more than *debounceTime* seconds
                    state = 4;
                    debounceCount = 0;
                    return 0;
                }
